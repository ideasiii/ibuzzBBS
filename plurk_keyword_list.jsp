...
String dbname = "plurk_keyword_crawl_list";
...
<script type="text/javascript">
	function loadPlurkKeyword(keywords){
...
<body onLoad="loadPlurkKeyword('<%=keywords%>');">
<div id="wrapper" class="clear">
    <div id="main" style="width:700px">
	<div >
		<h2>Plurk擷取關鍵字列表</h2><br/>
		...
		%>
		    <br/><li style="margin-top:15px"><%=itemJSON.getString("category")%></></li>
		<%  }%>		
		    <input type="checkbox" name="keyword" id="keyword" value="<%=itemJSON.getString("keyword")%>"><%=itemJSON.getString("keyword")%>&nbsp;
		<%
		    category = itemJSON.getString("category");
		}%>		
		</ul>
	  <input type="button" value="送出" class="btnposition" onClick="addPlurkKeyword();">
	  <input type="button" value="全部清除" class="btnposition" onClick="clearPlurkKeyword();">
